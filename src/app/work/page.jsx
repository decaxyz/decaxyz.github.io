  ...
  return (
    <>
      ...
      >
        ...
        <p className='mt-5'>
          {"Time and again, Deca Labs listens to client's describe their problems, and then thinks outside the box to right-size a solution, often using enterprise-grade software, which will scale to their needs today, tomorrow, and years from now."}
        </p>
        <p className='mt-5'>
      ...
      >
        Honestly, we were a bit desperate when we approached <em>Deca Labs</em>.
